...
public class TwoNote_3blue_1red extends SequentialCommandGroup {
   ...
   */
  public TwoNote_3blue_1red(Launcher launcher, Intake intake, Drivetrain drivetrain, WristIntake wristintake) {
    m_launcher = launcher;
    m_intake = intake;
