...
public class ThreeNote_leftfirst_2 extends SequentialCommandGroup {
   ...
   */
  public ThreeNote_leftfirst_2(Launcher launcher, Intake intake, Drivetrain drivetrain, WristIntake wristintake) {
    m_launcher = launcher;
    m_intake = intake;
    ...
    new SequentialCommandGroup(
      ...
      new TurnAutoCommand(drivetrain, 40, 0.02),
      new ParallelCommandGroup(
