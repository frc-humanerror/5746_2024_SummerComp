...
public class OneNote_moveOut_3blue_1red extends ParallelCommandGroup {
   ...
   */
  public OneNote_moveOut_3blue_1red(Launcher launcher, Intake intake, Drivetrain drivetrain) {
    m_launcher = launcher;
    m_intake = intake;
