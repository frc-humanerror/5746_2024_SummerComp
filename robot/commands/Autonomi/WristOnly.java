...
public class WristOnly extends SequentialCommandGroup {
   ...
   */
  public WristOnly(Launcher launcher, Intake intake, Drivetrain drivetrain, WristIntake wristintake) {
    m_launcher = launcher;
    m_intake = intake;
    ...
    new SequentialCommandGroup(
      new ParallelCommandGroup(
        ...
        new IntakeAutoCommand(intake, 4, 1, true)
      ),
      new ParallelCommandGroup(
        new ReverseWristAutoCommand(wristintake, false),
        new IntakeAutoCommand(intake, 1, 0, false)
      )
    )
    );
  }
